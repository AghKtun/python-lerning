<p align="center"><b>Глоссарий</b></p>
...
✅ В качестве названия переменных запрещено использовать ключевые (зарезервированные) слова. Прочесть его на русском языке можно по ссылке: https://pyplanet.ru/article/pep-0008.html.
